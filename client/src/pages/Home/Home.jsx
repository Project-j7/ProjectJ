            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div className="navbar-nav m-auto">
                        ...
                        <a className="nav-link navItem_lg" href="#"></a>
                        <a className="nav-link navItem_lg" href="#"></a>
                        <a className="nav-link navItem_lg" href="#"></a>
                    </div>
                    <button id="login_signup_button_lg">Get in Touch</button>
                </div>
            </div>
        </nav>
                ...
                <div className="column">
                    <div className="row">
                        <div className="col-7" style={{marginTop:"100px"}}>
                            ...
                            <p style={{color:"#71717a", fontSize:"18px", marginTop:"15px"}}>Discover the art of jewellery design enhanced by cutting-edge GAN<br/> technology, transforming low-auality images into stunning, high resolution<br/> masterpieces.</p>
                ...
                <div className="column">
                    <div className="row" style={{width:"100%"}}>
                        <div className="col-12">
                            ...
                            <p style={{color:"grey"}} className="text-center">Enhance your jewellery designs effortlessly. Our tool uses Deep Learning technology to create<br/>high-quality visuals that capture the essence of luxury.</p>
                        </div>
                        ...
                        <div className="col-12" style={{marginTop:"100px", padding:"50px 0 50px 150px", backgroundColor:"whitesmoke"}}>
                            ...
                            <div className="mt-5 d-flex flex-row justify-content-start">
                                ...
                                <div style={{marginRight:"100px"}}>
                                    ...
                                    <p>Step 2: Generative Designs</p>
                                    <p style={{color:"grey"}}>Watch as our GAN technology crafts stunning<br/>designs in real-time</p>
                                </div>
                                <div style={{marginRight:"100px"}}>
                                    <i className="fa-solid fa-cloud-arrow-down mb-3" style={{fontSize: "25px", color:"#347273"}}></i>
                                    <p>Step 3: Customize & Order</p>
                                    <p style={{color:"grey"}}>Personalize your favourite designs and place your<br/>order effortlessly</p>
                                </div>
                            </div>
                        </div>
                    </div>
