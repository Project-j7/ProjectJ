                        ...
                        <div className="row">
                            <div className="col-7" style={{marginTop: "100px"}}>
                                <h1 style={{
                                    ...
                                    fontWeight: "bolder",
                                    fontSize: "65px"
                                }}>Elevate Your<br/>Jewellery<br/> Experience</h1>
                                <p style={{color: "#71717a", fontSize: "18px", marginTop: "15px"}}>Discover the art of
                                    jewellery design enhanced by Deep Learning<br/> Technology, transforming low-quality
                            ...
                            <div className="col-5">
                                <img className="w-75 img-fluid" style={{marginTop: "145px", borderRadius: "25px"}}
                                     alt="image"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="column">
                        <div className="row" style={{width: "100%"}}>
                            <div className="col-12">
                                <h1 className="text-center" style={{fontSize: "20px", color: "#347273"}}>Key
                                    Features</h1>
                                <h1 style={{color: "black", fontSize: "45px", fontWeight: "600"}}
                                    className="text-center">Innovate your Design</h1>
                                <p style={{color: "grey"}} className="text-center">Enhance your jewellery designs
                            ...
                            <div className="col-12 d-flex flex-row justify-content-center">
                                <div style={{
                                    ...
                                    <i className="fa-solid fa-robot mb-4"
                                       style={{fontSize: "25px", color: "#347273"}}></i>
                                    <h1 style={{fontSize: "15px", color: "black"}}>Creative Design Generation</h1>
                                    <p style={{color: "grey"}}>Generate unique and realistic<br/>jewellery designs based
                                ...
                                <div style={{
                                    ...
                                    <i className="fa-solid fa-handshake-simple mb-4"
                                       style={{fontSize: "25px", color: "#347273"}}></i>
                                    <h1 style={{fontSize: "15px", color: "black"}}>User-Friendly Interface</h1>
                                    <p style={{color: "grey"}}>Navigate through our sleek and<br/>modern interface
                                ...
                                <div style={{
                                    ...
                                    <i className="fa-solid fa-star mb-4"
                                       style={{fontSize: "25px", color: "#347273"}}></i>
                                    <h1 style={{fontSize: "15px", color: "black"}}>Seamless Integration</h1>
                                    <p style={{color: "grey"}}>Easily integrate your designs into<br/>your existing
                            ...
                            <div className="col-12" style={{
                                ...
                                <div className="mt-5 d-flex flex-row justify-content-start">
                                    <div style={{marginRight: "100px"}}>
                                        ...
                                        <p style={{color: "grey"}}>Easily upload your low-quality jewellery images
                                            for<br/>enhancement</p>
                                    </div>
                                    <div style={{marginRight: "100px"}}>
                                        <i className="fa-solid fa-arrows-rotate mb-3"
                                           style={{fontSize: "25px", color: "#347273"}}></i>
                                        <p>Step 2: Processing</p>
                                        <p style={{color: "grey"}}>Watch as our Deep Learning technology crafts stunning<br/>designs
                                            in real-time</p>
                                    </div>
                                    <div style={{marginRight: "100px"}}>
                                        ...
                                        <p style={{color: "grey"}}>Save the high quality image to your<br/> device with
                                            a quick click</p>
                                    </div>
                                </div>
                            </div>
